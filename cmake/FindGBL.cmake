...
FIND_PATH( GBL_INCLUDE_DIR
	...
	PATHS /home/zhuyifan/Software/GBL/master/install/include
	NO_DEFAULT_PATH
)
IF( NOT GBL_INCLUDE_DIR )
    MESSAGE( STATUS "Check for GBL: /home/zhuyifan/Software/GBL/master/install"
...
FOREACH( libname ${GBL_LIB_NAMES} )
    ...
    FIND_LIBRARY( GBL_LIB_${ulibname}
        NAMES ${libname}
        PATHS /home/zhuyifan/Software/GBL/master/install
        PATH_SUFFIXES lib
        NO_DEFAULT_PATH )
...
IF( GBL_INCLUDE_DIR AND NOT GBL_FINDLIB_FAILED )
    SET( GBL_FOUND TRUE )
    SET( GBL_INCLUDE_DIRS ${GBL_INCLUDE_DIR} ${GBL_INCLUDE_DIR}/GBL /cvmfs/sft.cern.ch/lcg/views/LCG_97rc4python3/x86_64-centos7-gcc9-opt/include )
    SET( GBL_LIBRARY_DIRS /home/zhuyifan/Software/GBL/master/install/lib /cvmfs/sft.cern.ch/lcg/views/LCG_97rc4python3/x86_64-centos7-gcc9-opt/lib )
	SET( GBL_LIBRARIES ${GBL_LIBS} )
...
ELSE()
	IF( GBL_FIND_REQUIRED )
		MESSAGE( FATAL_ERROR "Check for GBL: /home/zhuyifan/Software/GBL/master/install -- failed!!" )
