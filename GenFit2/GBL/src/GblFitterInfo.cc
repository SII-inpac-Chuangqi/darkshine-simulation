...
namespace genfit {
  ...
  genfit_gbl::GblPoint GblFitterInfo::constructGblPoint() {
    ...
    genfit_gbl::GblPoint thePoint(jacobian_);
  ...
  void GblFitterInfo::updateFitResults(genfit_gbl::GblTrajectory& traj) {  
    if (!traj.isValid())
      return;
