...
namespace genfit {
  ...
  public:
     ...
     */
    void updateGblInfo(genfit_gbl::GblTrajectory& traj, genfit::Track* trk, const genfit::AbsTrackRep* rep);
    
    /**
     * @brief Constructs all GBL points and returns them in vector
     * for trajectory construction
     * 
     * @return const std::vector< genfit_gbl::GblPoint, std::allocator >&
     */
    std::vector<genfit_gbl::GblPoint> collectGblPoints(genfit::Track* trk, const genfit::AbsTrackRep* rep);
