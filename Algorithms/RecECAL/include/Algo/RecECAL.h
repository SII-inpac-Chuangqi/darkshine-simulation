...
public:
    ...
    void InitEvt() override {
        ...
        ECAL_NHits.clear();
        ECAL_Emean.clear();
        ECAL_COG_X_mean.clear();
        ECAL_COG_Y_mean.clear();
        ECAL_COG_Z_mean.clear();
        ECAL_Ecenter.clear();
        ECAL_Ecenter_3.clear();
        ECAL_Ecenter_5.clear();
        ECAL_Ecenter_7.clear();
        ECAL_E1E3_center.clear();
        ECAL_E1E5_center.clear();
        ECAL_E1E7_center.clear();
        ECAL_E3E5_center.clear();
        ECAL_E3E7_center.clear();
        ECAL_Hits_XWidth.clear();
        ECAL_Hits_YWidth.clear();
        ECAL_Hits_ZDepth.clear();
        ECAL_Ecell_max.clear();
        ECAL_Ecell_second.clear();
        ECAL_Ecell_max_sec_diff.clear();
        ECAL_Ecell_max_sec_dist.clear();
        ECAL_Ecell_max_3.clear();
        ECAL_Ecell_max_5.clear();
        ECAL_Ecell_max_7.clear();
        ECAL_E1E3_max.clear();
        ECAL_E1E5_max.clear();
        ECAL_E1E7_max.clear();
        ECAL_E3E5_max.clear();
        ECAL_E3E7_max.clear();
        ECAL_E1Edep_max.clear();
        ECAL_E1Edep_max.clear();
        ECAL_E3Edep_max.clear();
        ECAL_E5Edep_max.clear();
        ECAL_E7Edep_max.clear();
        ECAL_Shower_start.clear();
        ECAL_Shower_end.clear();
        ECAL_Hit_layer.clear();
        ECAL_Shower_radius.clear();
        ECAL_Weighted_radius.clear();
        ECAL_Shower_layer.clear();
        ECAL_Shower_layer_ratio.clear();
        ECAL_Shower_density.clear();
        ECAL_Shower_length.clear();
        ECAL_FD_2D_mean.clear();
        ECAL_FD_2D_rms.clear();
        ECAL_FD_3D_mean.clear();
        ECAL_FD_3D_rms.clear();
...
//    double Moments_Z[4] = {0.};
    ...
    vector<int> ECAL_NHits{};
    vector<double> ECAL_Emean{};
    vector<double> ECAL_COG_X_mean{};
    vector<double> ECAL_COG_Y_mean{};
    vector<double> ECAL_COG_Z_mean{};
    vector<double> ECAL_Ecenter{};
    vector<double> ECAL_Ecenter_3{};
    vector<double> ECAL_Ecenter_5{};
    vector<double> ECAL_Ecenter_7{};
    vector<double> ECAL_E1E3_center{};
    vector<double> ECAL_E1E5_center{};
    vector<double> ECAL_E1E7_center{};
    vector<double> ECAL_E3E5_center{};
    vector<double> ECAL_E3E7_center{};
    vector<double> ECAL_Hits_XWidth{};
    vector<double> ECAL_Hits_YWidth{};
    vector<double> ECAL_Hits_ZDepth{};
    vector<double> ECAL_Ecell_max{};
    vector<double> ECAL_Ecell_second{};
    vector<double> ECAL_Ecell_max_sec_diff{};
    vector<double> ECAL_Ecell_max_sec_dist{};
    vector<double> ECAL_Ecell_max_3{};
    vector<double> ECAL_Ecell_max_5{};
    vector<double> ECAL_Ecell_max_7{};
    vector<double> ECAL_E1E3_max{};
    vector<double> ECAL_E1E5_max{};
    vector<double> ECAL_E1E7_max{};
    vector<double> ECAL_E3E5_max{};
    vector<double> ECAL_E3E7_max{};
    vector<double> ECAL_E1Edep_max{};
    vector<double> ECAL_E3Edep_max{};
    vector<double> ECAL_E5Edep_max{};
    vector<double> ECAL_E7Edep_max{};
    vector<int> ECAL_Shower_start{};
    vector<int> ECAL_Shower_end{};
    vector<int> ECAL_Hit_layer{};
    vector<double> ECAL_Shower_radius{};
    vector<double> ECAL_Weighted_radius{};
    vector<int> ECAL_Shower_layer{};
    vector<double> ECAL_Shower_layer_ratio{};
    vector<double> ECAL_Shower_density{};
    vector<int> ECAL_Shower_length{};
    vector<double> ECAL_FD_2D_mean{};
    vector<double> ECAL_FD_2D_rms{};
    vector<double> ECAL_FD_3D_mean{};
    vector<double> ECAL_FD_3D_rms{};
