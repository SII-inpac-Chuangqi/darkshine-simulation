...
//close gcc -Wdeprecated-copy warning in this file
 ...
 */
    GblHelixPrediction::GblHelixPrediction(double sArc, const Vector2d& aPred,
                                           ...
                                           sarc(sArc), pred(aPred), tdir(tDir), udir(uDir), vdir(vDir), ndir(nDir), pos(aPos)
    {
 ...
 */
    GblSimpleHelix::GblSimpleHelix(double aRinv, double aPhi0, double aDca,
                                   ...
                                   rinv(aRinv), phi0(aPhi0), dca(aDca), dzds(aDzds), z0(aZ0), cosPhi0(cos(phi0)), sinPhi0(sin(phi0)),
                                   xRelCenter(-(1. - dca * rinv) * sinPhi0), yRelCenter((1. - dca * rinv) * cosPhi0)
    {}
 ...
 */
    double GblSimpleHelix::getArcLengthR(double aRadius) const
    {
        ...
        if (0.5 * rinv * rinv * (aRadius * aRadius - dca * dca) - 1. + rinv * dca > 0.)
 ...
 */
    GblDetectorLayer::GblDetectorLayer(const std::string aName,
                                       ...
                                       name(aName), layer(aLayer), measDim(aDim), xbyx0(thickness), center(aCenter),
                                       resolution(aResolution), precision(aPrecision), global2meas(measTrafo), global2align(alignTrafo)
    {
 ...
 * \param [in]  hlx  helix
 */
    GblHelixPrediction GblDetectorLayer::intersectWithHelix(GblSimpleHelix hlx) const
    {
 ...
 */
    Matrix<double, 3, 6> GblDetectorLayer::getRigidBodyDerGlobal(Eigen::Vector3d& position, Eigen::Vector3d& direction) const
    {
 ...
 * \param[in] direction  track direction
 */
    Matrix<double, 2, 6> GblDetectorLayer::getRigidBodyDerLocal(Eigen::Vector3d& position, Eigen::Vector3d& direction) const
    {
 ...
 */
    Matrix<double, 6, 6> GblDetectorLayer::getTrafoGlobalToLocal(Eigen::Vector3d& offset, Eigen::Matrix3d& rotation) const
    {
 ...
 * \param[in] rotation  rotation of alignment system
 */
    Matrix<double, 6, 6> GblDetectorLayer::getTrafoLocalToGlobal(Eigen::Vector3d& offset, Eigen::Matrix3d& rotation) const
    {
