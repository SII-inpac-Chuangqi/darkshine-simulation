...
// ********************************************************************
//
/// \file /include/GB01BOptrMultiParticleChangeCrossSection.hh
/// \brief Definition of the BOptrMultiParticleChangeCrossSection class
//
//-----------------------------------------------------------------
//
...
//        In the present case, the BOptrChangeCrossSection
...
#ifndef BOptrMultiParticleChangeCrossSection_hh
#define BOptrMultiParticleChangeCrossSection_hh 1
...
public:
  BOptrMultiParticleChangeCrossSection(G4String BP);
  ...
  // -- in the main program.
  void AddParticle( G4String particleName, G4double BF, G4double Em, G4String BP);
...
private:
  ...
  std::map < const G4ParticleDefinition*, 
             BOptrChangeCrossSection* >    fBOptrForParticle;
