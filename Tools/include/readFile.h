...
#ifndef QPLOT_READFILE_H
#define QPLOT_READFILE_H
...
public:
  ...
  [[nodiscard]] std::size_t size() const { return m_data.size() - 1; }
...
public:
  ...
  explicit CSVIterator(std::istream &str) : m_str(str.good() ? &str : nullptr) {
    ++(*this);
  }
