...
cmake -DWITH_GEANT4_UIVIS=OFF -DCMAKE_INSTALL__DSS_TEST_PREFIX=${_DSS_TEST_PREFIX}/install -DCMAKE_BUILD_TYPE=RelWithDebInfo ../ >${_DSS_TEST_PREFIX}/test/DSS.build.log 2>&1 \
                && make install -j16 >>${_DSS_TEST_PREFIX}/test/DSS.build.log 2>&1
_DSS_TEST_STATUS=$?
